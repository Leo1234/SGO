...
function Datepicker() {
	...
	this.regional[''] = { // Default regional settings
		closeText: 'Concluir', // Display text for close link
		prevText: 'Anerior', // Display text for previous month link
		...
		dayNames: ['Domingo', 'Segunda', 'Terça', 'Quarta', 'Qinta', 'Sexta', 'Sábado'], // For formatting
...
$.extend(Datepicker.prototype, {
	...
	/* Pop-up the date picker in a "dialog" box.
	   ...
	   @param  pos       int[2] - diretoriasinates for the dialog's position within the screen or
	                     event - with x/y diretoriasinates or
